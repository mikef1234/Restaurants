...
!function(e){var t={init:function(t){return this.each(function(){t.container.hasClass("active_container")||t.container.find(".layer").map(function(){var t=e(this).attr("data-show-effect"),n=e(this).attr("data-time"),r=e(this).attr("data-show-delay");e(this).addClass("animated "+t).css({"animation-delay":r+"ms","animation-duration":n+"ms"})})})}};e.fn.magicLayout=function(n){return t[n]?t[n].apply(this,Array.prototype.slice.call(arguments,1)):"object"!=typeof n&&n?void e.error("This"+n+" is not defined"):t.init.apply(this,arguments)}}(jQuery);
!function(e){var t=e("body"),n={displays:e(".display_js"),init:function(){var t=n.getActiveDisplay();e(this).magicLayout({container:t}),n.sedtBodyId(t),e(document).on("scroll",function(){n.setActiveDisplay()})},getActiveDisplay:function(){var t,r,i,o=e(window).scrollTop();return r=n.displays.filter(function(n,r){return i=e(r),t=i.offset().top,o>=t&&o<t+i.outerHeight()})},setActiveDisplay:function(){var t=e(window).scrollTop(),r=n.getActiveDisplay();t>r.offset().top+r.outerHeight()/2&&(e(this).magicLayout({container:r.next()}),e(this).magicLayout({container:r})),r.hasClass("display_active")||(n.sedtBodyId(r),r.addClass("display_active").siblings(".display_js").removeClass("display_active"),e("[data-scroll-nav="+n.displays.index(r)+"]").addClass("nav__link_active").siblings().removeClass("nav__link_active"))},sedtBodyId:function(e){t.attr("id",e.attr("id")+"_active")},scroll:function(r){var i=r.attr("data-id-section"),o=e("#"+i),a=o.offset().top;e(this).addClass("nav__link_active").siblings().removeClass("nav__link_active"),e("html, body").animate({scrollTop:a},1200),t.removeClass("nav-panel_active"),n.sedtBodyId(o),o.hasClass("active_container")||e(this).magicLayout({container:o})}};n.init(),e("#action_button").on("click",function(){location.reload()})}(jQuery);
